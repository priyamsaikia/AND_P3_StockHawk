...
public class AppConstants {
    ...
    public static final String REQUEST_STOCK_HISTORY = "select * from yahoo.finance.historicaldata where symbol = \"%s\" and startDate = \"2009-09-11\" and endDate = \"2010-03-10\"";
